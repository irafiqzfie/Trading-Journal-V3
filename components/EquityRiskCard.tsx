...
const EquityRiskCard: React.FC<EquityRiskCardProps> = ({
  ...
  const inputClasses = "block w-full bg-black/20 border-2 border-stone-700 rounded-md shadow-sm text-white focus:ring-0 focus:border-brand-primary transition-all p-2 text-lg";

  return (
    <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-lg shadow-lg py-6 pr-6 pl-8 h-full flex flex-col relative overflow-hidden group transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-1 hover:border-white/20">
      ...
      <div className="flex-grow flex flex-col justify-center">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
          ...
          <div>
            ...
            <div
              id="calculatedRisk"
              className={`${inputClasses} flex items-center bg-black/25`}
              aria-live="polite"
            >
