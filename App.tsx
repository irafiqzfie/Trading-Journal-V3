...
import { analyzeTradingHabits } from './services/geminiService';
...
const App: React.FC = () => {
  ...
  const handleAnalyze = async () => {
    ...
    setIsAnalysisVisible(true);
    try {
      const result = await analyzeTradingHabits(positionsToAnalyze);
      setAnalysis(result);
    } catch (error) {
      console.error("Analysis failed:", error);
      setAnalysisError("Failed to analyze trading habits. Please check the console for details.");
    } finally {
